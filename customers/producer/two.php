...
<!--  TITLE  -->
<div class="mt-5">
    <a class="mb-sm-5 pt-sm-5"><img src="../../main/media/images/producers/header-image-of-two.jpg"
                                    width="1583px"
                                    height="1055.59px"></a>
            ...
            <section>
                ...
                <div class="row mx-sm-4">
                    ...
                    <section class="d-sm-flex mx-sm-2 my-sm-5 pt-sm-5">
                        ...
                        <div>
                            <a class="ms-md-5"><img src="../../main/media/images/producers/body-1-of-two.jpg"
                                                    width="630px"
                                                    height="841px"></a>
                        </div>
                    </section>
                    ...
                    <section class="d-sm-flex mx-sm-2 pt-sm-5">
                        <div>
                            <a><img src="../../main/media/images/producers/body-2.1-of-two.jpg"
                                    width="605px"
                                    height="580px"></a>
                        </div>
                        <div class="mx-sm-4">
                            <a><img src="../../main/media/images/producers/body-2.2-of-two.jpg"
                                    width="307px"
                                    height="580px"></a>
                        </div>
                        <div>
                            <div class="mb-sm-4">
                                <a><img src="../../main/media/images/producers/body-2.3-of-two.jpg"
                                        width="307px"
                                        height="280px"></a>
                            </div>
                            <div>
                                <a><img src="../../main/media/images/producers/body-2.4-of-two.jpg"
                                        width="307px"
                                        height="285px"></a>
                            </div>
                        </div>
                    ...
                    <section class="d-sm-flex mx-sm-2 pt-sm-5">
                        <div>
                            <a><img src="../../main/media/images/producers/body-3-of-two.jpg"
                                    width="600px"
                                    height="600px"></a>
                        </div>
