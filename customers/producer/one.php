...
<!--  TITLE  -->
<div class="mt-5">
    <a class="mb-sm-5 pt-sm-5"><img src="../../main/media/images/producers/header-image-of-one.jpg"
                                    width="1583px"
                                    height="1055.59px"></a>
            ...
            <section>
                ...
                <div class="row mx-sm-4">
                    ...
                    <section class="d-sm-flex mx-sm-2 my-sm-5 pt-sm-5">
                        ...
                        <div>
                            <a class="ms-md-5"><img src="../../main/media/images/producers/body-1-of-one.jpg"
                                                    width="630px"
                                                    height="486px"></a>
                        </div>
                    </section>
                    ...
                    <section class="d-sm-flex mx-sm-2 pt-sm-5">
                        <div>
                            <a><img src="../../main/media/images/producers/body-2-of-one.jpg"
                                    width="1260px"
                                    height="937.17px"></a>
                        </div>
                    </section>
                    ...
                    <section class="d-sm-flex mx-sm-2 pt-sm-5">
                        <div>
                            <a><img src="../../main/media/images/producers/body-3-of-one.jpg"
                                    width="850px"
                                    height="556.45px"></a>
                        </div>
                    ...
                    <section class="mx-sm-2 my-sm-5 pt-sm-5">
                        ...
                        <div class="me-md-5 mt-sm-1 d-sm-flex">
                            <a class="me-sm-5"><img src="../../main/media/images/producers/body-4.1-of-one.jpg"
                                                    width="610px"
                                                    height="412px">
                            </a>
                            <a><img src="../../main/media/images/producers/body-4.2-of-one.jpg"
                                    width="605px"
                                    height="412px">
                            </a>
                        </div>
                    ...
                    <section class="d-sm-flex mx-sm-2 pt-sm-5">
                        ...
                        <div>
                            <a class="ms-md-5"><img src="../../main/media/images/producers/body-5-of-one.jpg"
                                                    width="850px"
                                                    height="556.45px"></a>
                        </div>
                    </section>
                    ...
                    <section class=" mx-sm-2 mt-sm-5 pt-sm-5">
                        ...
                        <div>
                            <a><img src="../../main/media/images/producers/body-6-of-one.jpg"
                                    width="1260px"
                                    height="1940px"></a>
                        </div>
                    </section>
