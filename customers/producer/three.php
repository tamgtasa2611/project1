...
<!--  TITLE  -->
<div class="mt-5">
    <a class="mb-sm-5 pt-sm-5"><img src="../../main/media/images/producers/header-image-of-three.jpg"
                                    width="1583px"
                                    height="1055.59px"></a>
            ...
            <section>
                ...
                <div class="row mx-sm-4">
                    ...
                    <section class="d-sm-flex mx-sm-2 my-sm-5 pt-sm-5">
                        ...
                        <div>
                            <a class="ms-md-5"><img src="../../main/media/images/producers/body-1-of-three.jpg"
                                                    width="630px"
                                                    height="945px"></a>
                        </div>
                    </section>
                    ...
                    <section class="d-sm-flex mx-sm-2 pt-sm-5">
                        <div>
                            <a><img src="../../main/media/images/producers/body-2-of-three.jpg"
                                    width="711px"
                                    height="1065px"></a>
                        </div>
                    ...
                    <section class="d-sm-flex mx-sm-2 pt-sm-5">
                        <div>
                            <a><img src="../../main/media/images/producers/body-3.1-of-three.jpg"
                                    width="636px"
                                    height="580px"></a>
                        </div>
                        <div class="ms-md-5">
                            <a><img src="../../main/media/images/producers/body-3.2-of-three.jpg"
                                    width="636px"
                                    height="580px"></a>
                        </div>
                    </section>
