...
<!--  TITLE  -->
<div class="mt-5">
    <a class="mb-sm-5 pt-sm-5"><img src="../../main/media/images/producers/header-image-of-six.jpg"
                                    width="1583px"
                                    height="1055.59px"></a>
            ...
            <section>
                ...
                <div class="row mx-sm-4">
                    ...
                    <section class="d-sm-flex mx-sm-2 my-sm-5 pt-sm-5">
                        ...
                        <div>
                            <a class="ms-md-5"><img src="../../main/media/images/producers/body-1-of-six.jpg"
                                                    width="630px"
                                                    height="945px"></a>
                        </div>
                    </section>
                    ...
                    <section class="d-sm-flex mx-sm-2 pt-sm-5">
                        <div>
                            <a><img src="../../main/media/images/producers/body-2-of-six.jpg"
                                    width="690px"
                                    height="819px"></a>
                        </div>
