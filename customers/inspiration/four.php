            ...
            <section>
                ...
                <div class="row mx-sm-4">
                    ...
                    <section class="d-sm-flex mx-sm-2 my-sm-5 pt-sm-5">
                        ...
                        <div>
                            <a class="ms-md-5"><img src="../../main/media/images/inspiration/body-1-of-four.jpg"
                                                    width="850px"
                                                    height="566.52px"></a>
                        </div>
                    </section>
                    ...
                    <section class="d-sm-flex mx-sm-2 pt-sm-5">
                        <div>
                            <a><img src="../../main/media/images/inspiration/body-2-of-four.jpg"
                                    width="580px"
                                    height="372.02px"></a>
                        </div>
                        <div class="ms-md-5">
                    ...
                    <section class="mx-sm-2 my-sm-5 pt-sm-5">
                        ...
                        <div class="mt-sm-5 ">
                            <a><img src="../../main/media/images/inspiration/body-3-of-four.jpg"
                                    width="1260px"
                                    height="859.77px"></a>
                        </div>
                    </section>
                    ...
                    <section class="d-sm-flex mx-sm-2 pt-sm-5">
                        ...
                        <div>
                            <a class="ms-md-5"><img src="../../main/media/images/inspiration/body-4-of-four.jpg"
                                                    width="630px"
                                                    height="419.58px"></a>
                        </div>
                    </section>
                    ...
                    <section class="d-sm-flex mx-sm-2 mt-sm-5 pt-sm-5">
                        <div>
                            <a><img src="../../main/media/images/inspiration/body-5-of-four.jpg"
                                    width="630px"
                                    height="390.58px"></a>
                        </div>
                        <div class="ms-md-5">
