            ...
            <section>
                ...
                <div class="row mx-sm-4">
                    ...
                    <section class="d-sm-flex mx-sm-2 my-sm-5 pt-sm-5">
                        ...
                        <div>
                            <a class="ms-md-5"><img src="../../main/media/images/inspiration/header-of-five.jpg"
                                                    width="740px"
                                                    height="470.52px"></a>
                        </div>
                    </section>

                    <a class="mx-sm-2 mb-sm-5 pt-sm-5"><img src="../../main/media/images/inspiration/five.jpg"
                                                            width="1245px"
                                                            height="850px"></a>
                    ...
                    <section class="d-sm-flex mx-sm-2 my-sm-5 pt-sm-5">
                        <div>
                            <a><img src="../../main/media/images/inspiration/body-1-of-five.jpg"
                                    width="850px"
                                    height="605.19px"></a>
                        </div>
                        <div class="ms-md-5">
                    ...
                    <section class="d-sm-flex mx-sm-2 pt-sm-5">
                        ...
                        <div>
                            <a class="ms-md-5"><img src="../../main/media/images/inspiration/body-2-of-five.jpg"
                                                    width="850px"
                                                    height="559.3px"></a>
                        </div>
                    ...
                    <section class="d-sm-flex mx-sm-2 my-sm-5 pt-sm-5">
                        <div>
                            <a>
                                <img src="../../main/media/images/inspiration/body-3.1-of-five.jpg"
                                     width="410px"
                                     height="615.38px">
                            </a>
                        </div>
                        ...
                        <div>
                            <a class="ms-md-5">
                                <img src="../../main/media/images/inspiration/body-3.2-of-five.jpg"
                                     width="410px"
                                     height="615.38px">
                            </a>
                        </div>
                    ...
                    <section class="d-sm-flex mx-sm-2 pt-sm-5">
                        <div>
                            <a class=""><img src="../../main/media/images/inspiration/body-4.1-of-five.jpg"
                                             width="410px"
                                             height="615.38px"></a>
                        </div>
                        <div>
                            <a class="ms-md-5"><img src="../../main/media/images/inspiration/body-4.2-of-five.jpg"
                                                    width="410px"
                                                    height="615.38px"></a>
                        </div>
                        <div>
                            <a class="ms-md-5"><img src="../../main/media/images/inspiration/body-4.3-of-five.jpg"
                                                    width="410px"
                                                    height="528.17px"></a>
                        </div>
                    </section>
                    ...
                    <section class="d-sm-flex mx-sm-2 mt-sm-5 pt-sm-5">
                        ...
                        <div>
                            <a class="ms-md-5"><img src="../../main/media/images/inspiration/body-5-of-five.jpg"
                                                    width="630px"
                                                    height="419.58px"></a>
                        </div>
                    </section>
