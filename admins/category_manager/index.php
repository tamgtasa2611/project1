        ...
        <div class="content-container">
            ...
            <table class="table table-striped table-hover table-borderless align-middle text-center nice-box-shadow">
                ...
                foreach ($categories as $category) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn bg-danger border-danger">
                                <a href="#delete-modal?cate=<?= $category['id'] ?>" class="text-white"
                    ...
                    <!--          modal  delete        -->
                    <div id="delete-modal?cate=<?= $category['id'] ?>" class="my-modal" style="z-index: 10">
                        <div class="modal__content">
                            <h2>Confirm delete</h2>

                            <p>
                                Do you really want to delete <span style="color: red"><?= $category['name'] ?></span>?
                            </p>

                            <div class="modal__footer">
                                <div>
                                    <a href="destroy.php?id=<?= $category['id'] ?>" class="btn btn-danger"
