<?php
session_start();
$_SESSION['direction'] = "today_completed.php";
...
<head>
    ...
    <title>Today's completed orders</title>
</head>
<body>
<?php
$search = "";
...
$sqlCountRecord = "SELECT COUNT(*) as count_record FROM orders 
                                ...
                                WHERE customers.name LIKE '%$search%' AND orders.date_buy = '$todayDate'
                                AND orders.status = 3";
...
<div id="content" class="">
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div class="content-container">
            <h4 class="content-heading">Today's Completed Orders List</h4>
