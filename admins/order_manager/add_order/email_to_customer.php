            ...
            <table role="presentation"
                                ...
                                <td style="padding:0 0 36px 0;color:#153643;">
                                    ...
                                    <table role="presentation" style="margin:0 0 12px 0;font-size:16px; width: 100%">
                                        ...
                                        foreach ($orders as $order) {
                                            ...
                                            <tr style="height: 40px">
                                                <td style="width: 260px; color: white">
                ...
                <tr>
                    <td style="text-align: center;padding-bottom: 36px;">
                        <p style="font-style: italic;">Notice something wrong? Cancel your order
                            <a href="http://localhost/project_1/customers/profile/order_history.php"
                               style="color: blue">
                                here</a></p>
                        <p style="">Thanks for being a great customer <span style="font-size: 20px">☺</span></p>
                    </td>
                </tr>
